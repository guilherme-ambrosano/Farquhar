...
def farquhar(temp=25.0,APAR=500.0):
    ...
    #vmax = taxa maxima de fotossintese limitada pela rubisco
    #Medlyn (soja)
    #kopt_vmax = 136.28
    #Ha_vmax = 75880
    #Hd_vmax = 200000
    #Topt_vmax = 34.95+273.15
    #vmax = medlyn(kopt_vmax, Ha_vmax, Hd_vmax, Topt_vmax, temp)
    ...
    Rd = 0.015*vmax/(1 + np.exp(1.3*(temp-(55+273.15))))
...
t = [0.1, 15.0, 25.0, 35.0, 45.0, 55.0]
r = [400.0, 400.0, 400.0, 400.0, 400.0, 400.0]
resultado = []
for i in range(len(t)):
    resultado.append(farquhar(t[i], r[i]))
